...
if(index==1){
  ...
  AppCubit.get(context).colors(0xffb51248);
               ...
               child: Icon( AppCubit.get(context).icon,color: Colors.white,),
               heroTag: "Add",
             ),
...
unselectedItemColor: Colors.black,
               ...
               items: [
                 BottomNavigationBarItem(icon: Icon(Icons.menu,color: Colors.white,size: 25.h,), label: "Tasks"),
                 BottomNavigationBarItem(
                     icon: Icon(Icons.check_circle_outline,color: Colors.white,size: 25.h,), label: "Done"),
                 BottomNavigationBarItem(
                     icon: Icon(Icons.archive_outlined,color: Colors.white,size: 25.h,), label: "Archived",),
               ],
             ),
